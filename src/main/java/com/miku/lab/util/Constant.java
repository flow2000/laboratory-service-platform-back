...
public class Constant {
    ...
    public static final String TOKEN_PREDIX="miku ";//token前缀
    public static final String TOKEN_SECRET="jwtsecret";
    public static final String TOKEN_ISS = "echisan";
    public static final long TOKEN_EXPIRATION = 3600L;//3600秒
    public static final long TOKEN_EXPIRATION_REMEMBER = 604800L;//记住我之后就是7天
